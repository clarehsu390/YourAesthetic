...
pin11 = Pin.create!(name: "Hamburgers", image_url: "https://res.cloudinary.com/dwetqmwgw/image/upload/v1501262514/bkdlusguav1hacj2jzhi.jpg", user: user3, description: "Burgers burgers burgers!")
